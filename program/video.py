...
@Client.on_message(command(["تشغيل_فيديو","/vplay", f"/vplay@{BOT_USERNAME}"]) & other_filters)
...
@Client.on_message(command(["رابط_مباشر","/vstream", f"/vstream@{BOT_USERNAME}"]) & other_filters)
